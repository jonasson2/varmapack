// ExtraUtils.h — Utilities used by example/demo and test programs
// (means, (co)variances, and approximate-equality helpers)
...
int almostAllSame(double a[], int n);              // is max diff. < 5e-14?

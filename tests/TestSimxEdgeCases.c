...
static void check_white_noise_with_exog(void) {
  ...
  varmapack_error error = varmapack_simx(0, 0, C, Sig, z, p, q, s, r, n, M,
                                         X0, h, X, E, rng);
  xCheck(!error);
  for (int j=0; j<M; j++) {
    for (int t=0; t<n; t++) {
...
static void check_arx_recursion(void) {
  ...
  varmapack_error error = varmapack_simx(A, 0, C, Sig, z, p, q, s, r, n, M,
                                         X0, h, X, E, rng);
  xCheck(!error);
...
static void check_no_return_shocks_reproducible(void) {
  ...
  varmapack_error error = varmapack_simx(A, B, C, Sig, z, p, q, s, r, n, M,
                                         X0, h, X1, E, rng);
  xCheck(!error);
  randompack_free(rng);
  rng = seededRng(102);
  error = varmapack_simx(A, B, C, Sig, z, p, q, s, r, n, M, X0, h, X2, 0, rng);
  xCheck(!error);
...
static void check_invalid_input(void) {
  int p = 1, q = 1, s = 1, r = 1, n = 4, M = 1, h = 2;
  double A[] = {0.4}, B[] = {0.2}, C[] = {0.3}, Sig[] = {1}, z[] = {1, 2, 3, 4};
  double X0[] = {0, 0}, X[4], E[4];
  randompack_rng *rng = seededRng(103);
  xCheck(varmapack_simx(0, B, C, Sig, z, p, q, s, r, n, M, X0, h, X, E, rng) ==
         VARMAPACK_INVALID_ARGUMENT);
  xCheck(varmapack_simx(A, B, 0, Sig, z, p, q, s, r, n, M, X0, h, X, E, rng) ==
         VARMAPACK_INVALID_ARGUMENT);
  xCheck(varmapack_simx(A, B, C, Sig, 0, p, q, s, r, n, M, X0, h, X, E, rng) ==
         VARMAPACK_INVALID_ARGUMENT);
  xCheck(varmapack_simx(A, B, C, Sig, z, p, q, s, r, n, M, 0, h, X, E, rng) ==
         VARMAPACK_INVALID_ARGUMENT);
  xCheck(varmapack_simx(A, B, C, Sig, z, p, q, s, r, n, M, X0, 1, X, E, rng) ==
         VARMAPACK_INVALID_ARGUMENT);
  xCheck(varmapack_simx(A, B, C, Sig, z, p, q, s, r, n, M, X0, h, 0, E, rng) ==
         VARMAPACK_INVALID_ARGUMENT);
  xCheck(varmapack_simx(A, B, C, Sig, z, p, q, s, r, n, M, X0, h, X, E, 0) ==
         VARMAPACK_INVALID_ARGUMENT);
  randompack_free(rng);
}

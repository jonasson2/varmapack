...
Options:
  ...
  -b count    discarded varm burn-in values per path (default: $burnin)
...
cmd="$cmd TimeSimulate('t', $t, 'w', $w, 'n', $n, 'M', $M, 'selected', $selected, "
cmd="$cmd 'platform', $platform, 'burnin', $burnin)"

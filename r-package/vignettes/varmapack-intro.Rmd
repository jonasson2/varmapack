%\VignetteIndexEntry{Introduction to varmapack}
%\VignetteEngine{knitr::rmarkdown}
%\VignetteEncoding{UTF-8}
---
title: "Introduction to varmapack"
...
The **varmapack** package provides fast simulation of VARMA(p, q)
...
```r
remotes::install_github("jonasson/varmapack")
```

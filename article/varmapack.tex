...
with the first $h$ terms of the simulated series, and an $(n-h) \times M$ matrix
...
\begin{algorithm}[H]
  ...
  \begin{algorithmic}[1]
    ...
    \item Find the vector-Yule-Walker right-hand sides $G_j$ with \eqref{eq:Gj}.
    \item Solve for $S$.
...
the conditional distribution. When using Matlab, such factorization may be
determined via eigenvalue computation for $R$.
